...
<br/>
<h1><b><center>TRAININGS AND OPPORTUNITIES OF MATRIX CONSTRUCTIONS</center></b></h1>
<br/>
<div class="maindivcontainer">
</div>
<br/>
<?php ;
$sql = "SELECT*FROM trainingTable";
...
<img src="Upload1/<?=$row['trsImg1']?>" width="100%" height="50%">
<img src="Upload1/<?=$row['trsImg2']?>" width="100%" height="50%">
...
<div style="width:100%; height:50%;"> <?=$row['trsDes2']?></div>
<img src="Upload1/<?=$row['trsImg3']?>" width="100%" height="50%">
</div>
<div style="float:left; width:20%; ">

<img src="Upload1/<?=$row['trsImg4']?>" width="100%" height="50%">
<div style="width:100%; height:50%;"> <?=$row['trsDes3']?></div>
 </div>
<div style="float:left; width:20%; ">

<div style="width:100%; height:50%;"> <?=$row['trsDes4']?></div>
<img src="Upload1/<?=$row['trsImg5']?>" width="100%" height="50%">
</div>
</div>
	<?php }
	else {  ?>
...
<div  style="float:right; width:20%; ">
<img src="Upload1/<?=$row['trsImg1']?>" width="100%" height="50%">
<div style="width:100%; height:50%;"> <?=$row['trsDes1']?></div>
</div>
<div  style="float:right; width:20%; ">
<div style="width:100%; height:50%;"> <?=$row['trsDes2']?></div>
<img src="Upload1/<?=$row['trsImg2']?>" width="100%" height="50%">
...
<?php 
$sql = "SELECT*FROM opportunitiesTable";
...
<img src="Upload1/<?=$row['opIm']?>" width="100%" height="400px">
