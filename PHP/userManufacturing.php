...
<br/>
<h1><b><center>CONSTRUCTIONS AND MANUFACTURINGS OF MATRIX CONSTRUCTIONS</center></b></h1>
<br/>
<br/>
...
<br/>
<?php ;
$sql = "SELECT*FROM constructionTable";
...
<img src="Upload1/<?=$row['csImg1']?>" width="100%" height="100%">
</div>
<div  style="float:right; width:20%; ">
<?=$row['csDes1']?>
</div>
<div style="margin: 0 auto; width:20%; ">
<img src="Upload1/<?=$row['csImg2']?>" width="100%" height="50%">
<div style="width:100%; height:50%;"> <?=$row['csDes2']?></div>
</div>
<div style="float:left; width:20%; ">
<img src="Upload1/<?=$row['csImg3']?>" width="100%" height="50%">
<div style="width:100%; height:50%;"> <?=$row['csDes3']?></div>
 </div>
<div style="float:left; width:20%; ">
<img src="Upload1/<?=$row['csImg4']?>" width="100%" height="50%">
<img src="Upload1/<?=$row['csImg5']?>" width="100%" height="50%">
</div>
</div>
	<?php }
	else {  ?>
...
<?php 
$sql = "SELECT*FROM manufacturingTable";
...
<img src="Upload1/<?=$row['mnIm']?>" width="100%" height="400px">
