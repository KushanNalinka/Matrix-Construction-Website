...
<br/>
<h1><b><center>TOP LEVEL MANAGEMENT OF MATRIX CONSTRUCTIONS</center></b></h1>
<br/>
...
<div class="mancant">
		<div class="mdim">
		<img  width="200px" height="200px " class="logo" src = "Upload/<?=$row['managerImg']?>">
	</div>
		<div  class="mddes">
		<p><?= $row['managerDes']; ?></p>
	</div>
