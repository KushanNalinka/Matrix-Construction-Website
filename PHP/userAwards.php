...
if($result->num_rows>0)
{
	...
	{ if($row['aId']%2 == 0){?>
<br/><br/><br/>
<div width="100%" height="100px" style="background-color:#00FFFF;"> Awards and Certifications of the Year : <?=$row['aDa'];?></div>
<div style="width:100%; display:inline-flex; height:80%:" >
<div  style="float:right; width:20%; ">
<img src="Upload1/<?=$row['aImg1']?>" width="100%" height="100%">
</div>
<div  style="float:right; width:20%; ">
<?=$row['aDes1']?>
</div>
<div style="margin: 0 auto; width:20%; ">
<img src="Upload1/<?=$row['aImg2']?>" width="100%" height="50%">
<div style="width:100%; height:50%;"> <?=$row['aDes2']?></div>
</div>
<div style="float:left; width:20%; ">
<img src="Upload1/<?=$row['aImg3']?>" width="100%" height="50%">
<div style="width:100%; height:50%;"> <?=$row['aDes3']?></div>
 </div>
<div style="float:left; width:20%; ">
<img src="Upload1/<?=$row['aImg4']?>" width="100%" height="50%">
<img src="Upload1/<?=$row['aImg5']?>" width="100%" height="50%">
</div>
</div>
	<?php }
	else {  ?>
