...
<br/>
<h1><b><center>PROJECTS OF MATRIX CONSTRUCTIONS</center></b></h1>
<br/>
...
<br/><br/>
<div class="mainSl">
<div class="sl1"><img src="../IMAGES/sl1.jpg" width="100%" height="100%"></div>
<div class="sl2">
<img src="../IMAGES/sl2.jpg" width="100%" height="50%">
<img src="../IMAGES/sl3.jpg" width="100%" height="50%">
</div>
<div class="sl3"></div>
<div class="sl4">
<img src="../IMAGES/sl4.jpg" width="100%" height="50%">
<img src="../IMAGES/sl5.jpg" width="100%" height="50%">
 </div>
<div class="sl5">
<img src="../IMAGES/sl6.jpg" width="100%" height="50%">
<img src="../IMAGES/sl7.jpg" width="100%" height="50%">
</div>
</div>
<br/><br/>
<?php ;
...
if($result->num_rows>0)
{
	...
	{ if($row['prjsId']%2 == 0){?>
<br/><br/><br/>
<div style="width:100%; display:inline-flex; height:80%:" >
<div  style="float:right; width:20%; ">
<img src="Upload/<?=$row['prjsIm1']?>" width="100%" height="100%">
</div>
<div  style="float:right; width:20%; ">
<img src="Upload/<?=$row['prjsIm2']?>" width="100%" height="50%">
<img src="Upload/<?=$row['prjsIm3']?>" width="100%" height="50%">
</div>
<div style="margin: 0 auto; width:20%; ">
<?=$row['prjsDes1']?>
</div>
<div style="float:left; width:20%; ">
<img src="Upload/<?=$row['prjsIm4']?>" width="100%" height="50%">
<img src="Upload/<?=$row['prjsIm5']?>" width="100%" height="50%">
 </div>
<div style="float:left; width:20%; ">
<?=$row['prjsDes2']?>
</div>
...
<div style="width:100%; display:inline-flex; height:80%:">
<div  style="float:right; width:20%; "><?=$row['prjsDes1']?></div>
<div  style="float:right; width:20%; ">
<img src="Upload/<?=$row['prjsIm2']?>" width="100%" height="50%">
<img src="Upload/<?=$row['prjsIm3']?>" width="100%" height="50%">
</div>
