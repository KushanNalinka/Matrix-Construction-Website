...
<script src="../JS/heavyEngineeringJs.js"></script>
<style>
}
*{ 
	margin:0;
...
@keyframes example1 {
  0%   {background-color:#00FFFF; left:0px; top:0px;}
  25%  {background-color:#DC143C; left:200px; top:0px;}
  50%  {background-color:#00008B; left:200px; top:200px;}
  75%  {background-color:#9400D3; left:0px; top:200px;}
  100% {background-color:#1E90FF; left:0px; top:0px;}
}
.buttonrow
{
	display:inline-flex;
...
<br/>
<h1><b><center>HEAVY ENGINEERING OF MATRIX CONSTRUCTIONS</center></b></h1>
<br/><br/><br/>
<div style="width:100%; height:600px;" id="para" class="maincont"></div>
<div class="buttonrow">
<button class="hvbtn1" name="btn1" onclick="loadData('btn1')">Pile Technology</button>
<button class="hvbtn2"name="btn2" onclick="loadData('btn2')">Power Stations</button>
<button class="hvbtn3"  name="btn3" onclick="loadData('btn3')">Mechanical</button>
<button class="hvbtn4"  name="btn4" onclick="loadData('btn4')">Electrical</button>
</div>
<br/><br/>
<?php 
$sql = "SELECT*FROM heavyengineering";
...
<img src="Upload/<?=$row['hvImg']?>" width="100%" height="400px">
